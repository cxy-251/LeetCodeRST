...
``0001`` 至 ``0144`` 的多语言教程已经完成。``0001`` 至 ``0100`` 的两轮历史逐题审查、81 条规则归并和
14 项事实更正也已完成。

``0141`` 至 ``0144`` 按难度预算 6 分完成：Easy、Medium、Medium、Easy。下一批是 ``0145–0147``，
由 Easy、Medium、Medium 组成，合计 5 分；``0148`` 为 Medium，加入后会超过单批预算。新题继续直接执行
