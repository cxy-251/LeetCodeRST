...
当前已经完整审查 ``0001`` 至 ``0040``，下一批为 ``0041`` 至 ``0045``。
...
PR、提交和状态记录用于说明工作流程，题解质量判断仍以实际正文和代码为准。
...
* 精确约束支撑字符模型、数值宽度、索引边界、断言和结构前提；
* 固定域题同时说明精确工作量、约束内常数界和推广模型；
* 官方契约、平台接口和语言适配器分别说明；
* 字符串比较单位、返回坐标、输入规范化和构造峰值空间分别计算；
* 数值检查覆盖完整表达式链、容量乘积和最终窄化；
