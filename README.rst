...
下一题是 ``0011. Container With Most Water``。实际进度以 ``state/PROGRESS.toml`` 为准。
...
0001 至 0010 已完成。当前样板已经覆盖哈希表、链表、滑动窗口、二分分割、回文
中心扩展、周期索引、整数逐位反转、字符串到整数的阶段化扫描、整数回文的半反转，
以及带点号与星号语义的二维后缀记忆化匹配。下一题从 0011 开始；自动任务每次只精写
一道题，并以 RST 教学质量高于题量。
