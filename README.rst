...
下一题是 ``0042. Trapping Rain Water``。实际进度以 ``state/PROGRESS.toml`` 为准。
...
0001 至 0041 已完成。当前样板已经覆盖哈希表、链表、滑动窗口、二分分割、回文
...
原地哈希与循环置换。下一题从 0042 开始；自动任务按难度预算连续精写 1 至 3 道题，
并对每道题独立执行完整质量门。
...
::
   ...
   problems/
     ...
     0001-0100/
       ...
       0001-two-sum.rst
       ...
       0041-first-missing-positive.rst
   state/
     PROGRESS.toml
     CONCEPT_LEDGER.toml
