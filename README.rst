...
``0001`` 至 ``0147`` 的多语言教程已经完成。``0001`` 至 ``0100`` 的两轮历史逐题审查、81 条规则归并和
14 项事实更正也已完成。

``0145`` 至 ``0147`` 按难度预算 5 分完成：Easy、Medium、Medium。下一批是 ``0148–0150``，
由 Medium、Easy、Easy 组成，合计 4 分；完成 ``0150`` 后进入下一阶段规则范围。当前新题继续直接执行
