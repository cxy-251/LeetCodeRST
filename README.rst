...
``0001`` 至 ``0107`` 的多语言教程已经完成。``0051`` 至 ``0100`` 的第二轮逐题审查、81 条规则归并和
14 项事实更正也已完成。

``0105`` 至 ``0107`` 按难度预算 6 分完成：三道 Medium。下一批是 ``0108–0112``，由 Easy、Medium、
Easy、Easy、Easy 组成，合计 6 分。新题继续直接执行 ``docs/FORWARD_RULES_0101_0150.rst``。
