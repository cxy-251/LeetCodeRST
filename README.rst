...
已完成 ``0001–0155``、``0160`` 和 ``0162`` 的多语言教程；``0156–0159`` 与 ``0161`` 已按 Premium
规则登记。``0001`` 至 ``0100`` 的两轮历史逐题审查、81 条规则归并和 14 项事实更正也已完成。

本批完成 ``0155``、``0160``、``0162``，难度合计 5 分。下一批从 ``0163`` 开始：登记并跳过 Premium
``0163``，完成 ``0164`` Hard 与 ``0165`` Medium，合计 6 分。从 ``0151`` 起，所有后续题目统一使用并
持续维护 ``docs/FORWARD_RULES_0151_ONWARD.rst``。
