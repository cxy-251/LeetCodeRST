...
- 当前论文视频已经拆成两层文案：
  - `narrationText` 用于朗读，更口语化、更完整
  - `content.body / bullets` 用于屏幕显示，更技术化、更高信息密度
- 当前屏显稿不会只复述朗读稿，而是会额外补：
  - 术语解释
  - 方法分层
  - 关键约束条件
  - 技术要点列表
- 当前默认会优先把更多信息压到屏显稿里，而不是一味拉长朗读稿。
- 当论文属于综述或理论边界类问题时，屏显稿现在还会额外补：
  - “这篇论文的新意到底是什么”
  - “它不是新模型，而是新分类/新证明/新边界” 这类判断
- 当前 `LM Studio` 提示词已经更强调：
  - 先说论文真正解决了什么瓶颈
