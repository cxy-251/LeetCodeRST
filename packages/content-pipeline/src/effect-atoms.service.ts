...
export const LIFE_EFFECT_CONTROLS: EffectControlDefinition[] = [
  ...
  },
  {
    ...
    description: "Controls how vivid the main live cells look.",
    section: "cellularEffect",
    field: "primarySaturation",
    min: 0,
    max: 100,
    step: 1,
  },
  ...
  {
    id: "life-secondary-sat",
    kind: "range",
    label: "Secondary Saturation",
    description: "Controls how vivid the secondary cells look.",
    section: "cellularEffect",
    field: "secondarySaturation",
    min: 0,
    max: 100,
    step: 1,
  },
  ...
  },
  {
    id: "life-birth-sat",
    kind: "range",
    label: "Birth Saturation",
    description: "Controls how vivid the freshly born cells look.",
    section: "cellularEffect",
    field: "birthSaturation",
    min: 0,
    max: 100,
    step: 1,
  },
...
export const SNAKE_EFFECT_CONTROLS: EffectControlDefinition[] = [
  ...
  {
    id: "snake-primary-sat",
    kind: "range",
    label: "Primary Saturation",
    description: "Controls how vivid the main snake body tone looks.",
    section: "cellularEffect",
    field: "primarySaturation",
    min: 0,
    max: 100,
  ...
  {
    id: "snake-secondary-sat",
    kind: "range",
    label: "Secondary Saturation",
    description: "Controls how vivid the head / highlight tone looks.",
    section: "cellularEffect",
    field: "secondarySaturation",
    min: 0,
    max: 100,
  ...
  },
  {
    ...
    description: "Controls how vivid the food / accent blocks look.",
    section: "cellularEffect",
    field: "birthSaturation",
    min: 0,
    max: 100,
