...
export class ThreeLightsEngine {
  ...
  public renderFrame(params: ThreeLightsRenderParams) {
    ...
    this.bundle.glow.material.opacity = 0.003 * choreography.orbGain;
    this.bundle.core.material.opacity = 0.38 * choreography.orbGain;
    this.bundle.accent.material.opacity = 0.42 * choreography.rimGain;
    this.bundle.groundAura.material.opacity = 0.034 * choreography.auraGain;
    this.bundle.groundGlow.material.opacity = 0.1 * choreography.orbGain;
