...
const buildPerPaperPaths = ({
  ...
  return {
    sourceBundlePath: path.resolve("data/source-bundles/generated", `${batchId}-${safePaperId}.json`),
    analysisBundlePath: path.resolve("data/source-bundles/generated", `${batchId}-${safePaperId}.analysis.json`),
  };
};
