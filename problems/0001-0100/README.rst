...
``0001`` 至 ``0100`` 的首轮教程和 ``0051`` 至 ``0100`` 的第二轮逐题审查均已完成。第二轮产生的 81 条
promoted rules 与 14 项 active corrections 已归并为 ``../../docs/FORWARD_RULES_0101_0150.rst``，
历史题目正文保持原样。
...
* 完整前向规则：``../../docs/FORWARD_RULES_0101_0150.rst``；
* 事实更正索引：``../../state/REVIEW_INDEX.toml``。

下一动作
--------

开始 ``0101`` 至 ``0105``。生成前必须读取完整前向规则，不再逐份拼接十个第二轮批次。
