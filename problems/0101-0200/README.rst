...
公开题需要按冻结教学质量基线重写。``0127``、``0129–0148`` 已完成，
...
下一批单独返工 ``0149``：Hard，合计 4 分。该题需要证明整数方向向量的最大公约数约分、符号规范化与直线
等价关系，核对仅扫描后续点仍覆盖全局最优，并逐语言审查整数宽度、哈希键唯一性和 C 开放寻址资源路径。全部
11 道剩余返工完成前，``0166`` 保持暂停。
