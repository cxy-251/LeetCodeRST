...
本目录按题号顺序保存 0101 至 0200 的算法教程。当前范围处理已结束：完成 0101 至 0155、0160、0162、
0164 至 0169、0171 至 0174、0179、0187 至 0191、0198 至 0200；0156 至 0159、0161、0163、0170、0186
...
``0166–0169``、``0171–0174``、``0179``、``0187–0191`` 与 ``0198–0200`` 已按冻结基线生成。
后续题目从 ``0201`` 起写入 ``../0201-0300/``，本目录不再接收新题。
...
#. `0199. Binary Tree Right Side View <0199-binary-tree-right-side-view.rst>`_
#. `0200. Number of Islands <0200-number-of-islands.rst>`_
...
``0201`` 起的教程与当前下一入口见 ``../0201-0300/README.rst``。本范围已经结束新题生成；
当前历史静态审查已完成 ``0166–0167``，下一题为 ``0168``。
全项目的新题生成入口保持为 ``0219``，但在历史审查期间暂停；批次风险和黄金样本由
``../../state/BATCH_CONTRACT.toml`` 指定。
