...
本目录按题号顺序保存 0101 至 0200 的题目教程。当前题号进度仍为：完成 0101 至 0155、0160、0162、
0164 至 0165；0156 至 0159、0161、0163 登记为 Premium 跳过。每道公开题只有一个自包含 RST，正文与
十语言代码全部直接内联，不使用 ``.inc`` 或 ``.. include::``。

当前进入质量返工阶段。``0127``、``0129–0155``、``0160``、``0162``、``0164``、``0165`` 共 32 道
公开题需要按前 100 题与 0128 的教学质量基线重写。第一批 ``0127``、``0129``、``0130`` 已完成，
剩余题号以 ``../../state/PROGRESS.toml`` 的 ``needs_revision`` 为准；完成全部返工前不生成 0166。
...
当前及后续题目统一执行 ``../../docs/FORWARD_RULES_0151_ONWARD.rst`` 和
...
下一批返工 ``0131–0132``：``0131`` Medium、``0132`` Hard，合计 6 分。全部 29 道剩余返工完成前，
``0166`` 保持暂停。
