...
本目录按题号顺序保存 0101 至 0200 的题目教程。当前已完成 0101 至 0131。
...
* ``0131`` Medium = 2；
* 总分为 6；
* ``0132`` 为 Hard，加入后会超过本批预算。

执行规则
--------

本范围直接执行 ``../../docs/FORWARD_RULES_0101_0150.rst``、质量门、题目模板、解法与簻型策略以及
...
下一批为 ``0132–0133``：Hard + Medium = 6。``0134`` 为 Medium，不再加入。
