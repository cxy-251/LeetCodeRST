...
公开题需要按冻结教学质量基线重写。``0127``、``0129–0152`` 已完成，
...
下一批连续返工 ``0153–0154``：一道 Medium 与一道 Hard，合计 6 分。``0153`` 证明互异元素下
比较中点与右端即可按比例收缩候选区间；``0154`` 改用最小值见证不变量，证明等值时删除右端的安全性，
并给出重复值导致最坏线性时间的界。全部 7 道剩余返工完成前，``0166`` 保持暂停。
