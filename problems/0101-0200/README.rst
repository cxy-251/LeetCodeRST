...
公开题需要按冻结教学质量基线重写。``0127``、``0129–0146`` 已完成，
...
下一批单独返工 ``0147``：Medium，合计 2 分。该题需要证明已排序前缀、失序节点摘除与稳定插入、节点唯一
覆盖和无环终止，并分别核对普通指针版本与 Rust ``Box`` 所有权版本的状态映射和真实最好/最坏时间。全部
13 道剩余返工完成前，``0166`` 保持暂停。
