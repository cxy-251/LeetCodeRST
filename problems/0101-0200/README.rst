...
公开题需要按冻结教学质量基线重写。``0127``、``0129–0154`` 已完成，
...
下一批连续返工公开题 ``0155``、``0160``、``0162``：Medium、Easy、Medium，合计 5 分。
分别恢复前缀最小值栈、双链表换头对齐与相邻斜率保峰证明，并核对动态存储、节点身份、
Rust 共享尾链和一基到零基返回。全部 5 道剩余返工完成前，``0166`` 保持暂停。
