...
公开题需要按冻结教学质量基线重写。``0127``、``0129–0155``、``0160``、``0162`` 已完成，
...
下一批连续返工 ``0164–0165``：一道 Hard 与一道 Medium，合计 6 分。``0164`` 证明鸽巢下界、
桶内差严格小于桶宽、相邻非空桶覆盖最大间距及桶数线性；``0165`` 用有效数字跨度比较修订号，
避免机器整数溢出并统一缺失段与零段。全部 2 道返工完成前，``0166`` 保持暂停。
