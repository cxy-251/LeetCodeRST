...
本目录按题号顺序保存 0201 至 0300 的算法教程。当前已完成 0201 至 0213，下一入口为 0214。
...
下一批独立生成 ``0214`` Shortest Palindrome，完整处理只能在前端添加字符、最长回文前缀转化、
KMP 前缀函数最终 border、分隔符安全性和十语言字符/字节资源；具体合同见
