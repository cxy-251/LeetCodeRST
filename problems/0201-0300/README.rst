...
本目录按题号顺序保存 0201 至 0300 的算法教程。当前已完成 0201 至 0212，下一入口为 0213。
...
下一批生成 ``0213`` House Robber II 与 ``0214`` Shortest Palindrome，完整处理环形相邻约束的两段线性 DP，
以及最短回文前缀、KMP 前缀函数、分隔符和跨语言字符/字节适配；具体合同见
