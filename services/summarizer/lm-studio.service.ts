...
const SHORT_RESPONSE_SCHEMA_EXAMPLE = {
  ...
  ending: "如果你想看懂 agent 下一阶段怎么进化，这篇论文值得先读。",
  bullets: ["要点一", "要点二", "要点三"],
};
...
const buildPrompt = (
  ...
  const styleRules = compact
    ...
    : [
        ...
        "4. hook 要像前 3 秒开场，先说最值得看的点，不要复述标题，不要空话。",
        "5. 如果是综述/框架型论文，强调它重新整理了什么、统一了什么坐标系。",
        "6. 如果是理论论文，强调它证明了什么边界或不可能性。",
        "7. 如果是方法论文，强调怎么做、解决了什么真实瓶颈、带来什么结果。",
        "8. bullets 固定 3 条，每条 8 到 18 个汉字，是给屏幕显示的要点，不要句号、不要长句。",
        "9. 避免空泛表达，例如“通过这套全面图谱”“值得进一步展开”。",
        "10. 不要捏造实验数字；不确定就说贡献，不说具体数值。",
...
const buildReviewPrompt = ({
  ...
  return [
    ...
    "2. 先说最值得看的点，不要复述标题。",
    "3. 讲清问题、方法、价值，不要空话。",
    "4. method 和 value 必须体现论文真正的核心贡献。",
